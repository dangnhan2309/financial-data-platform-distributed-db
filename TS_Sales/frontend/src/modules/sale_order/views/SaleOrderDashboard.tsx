        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-4 gap-4">
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="text-3xl font-bold text-primary-600">{mockSaleOrders.length}</div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="text-gray-600 mt-2">Đã xác nhận</div>
                </div>
                <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="text-gray-600 mt-2">Tổng giá</div>
                </div>
            </div>
